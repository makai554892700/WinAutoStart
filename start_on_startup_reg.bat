...
set ScriptName=start_on_startup_reg.reg

::切换到中间层目录
cd /d %MidDir%

::斜杠转换
set AppFullPathTmp=%MidDir%%AppRelativePath%
set str1=^\
set str2=^\^\
set regs=%AppFullPathTmp%
set regs=!regs:%str1%=%str2%!
set AppFullPath=%regs%
...
echo "%AppName%"="%AppFullPath%" >> %ScriptName%
echo.  >> %ScriptName%
